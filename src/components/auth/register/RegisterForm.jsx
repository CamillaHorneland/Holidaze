...
function RegisterForm() {
  ...
  return (
    <div className="m-10">
      <h1 className="font-bold text-3xl text-dark-blue">Register:</h1>
      <div className="flex mt-8 m-4 mb-16">
        <div className="hidden md:block">
          <img src={image} alt="Register sign" className="max:w-56" />
        </div>
        <form className="w-full max-w-md mx-auto" onSubmit={handleSubmit(onSubmit)}>
          <fieldset className={`flex flex-col p-8 space-y-6 ${isLoading && "opacity-50"}`}>
            ...
            <div className="form-control flex flex-row items-center justify-center my-4">
              ...
              <input
                className="p-4 bg-light-blue border border-blue rounded-md mb-2"
